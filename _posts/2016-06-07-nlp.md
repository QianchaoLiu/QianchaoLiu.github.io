...
&nbsp;&nbsp;&nbsp;&nbsp;这里需要指出rnn的问题，我们知道由于input层(hidden层的time step)比较长(这个长度由corpus的sentence长度决定，可以是5也可以是50,也可以是一本书几万个word)，这就回导致gradient vanishing 和gradient explosion。下面推导gradient vanishing的原因。
